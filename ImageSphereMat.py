...
# ImageSphereMat.py: E field lines for charge plus image wi Matplotlib
...
Ex = np.zeros((Nx,Ny));       Ey = np.zeros((Nx,Ny))   # Ex, Ey arrays
xx = 3.0;   yy = 3.0                              # Charge coordidates
dq = np.sqrt(xx*2+yy*2);      a = 1.2          # Origin, sphere radius 
