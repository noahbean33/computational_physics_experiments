...
scene =  display(width=500, height=500,range=100,title="E of Charge Left of Plane (Red Image)")
plane = box(pos=(0,0,0),length=2,height=130,width=130,color=(0.9,0.9,0.9),opacity=0.5)
